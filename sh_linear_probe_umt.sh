...
OUTPUT='fewshot_video_report2/ActionRecognition'
MODEL_NAME='umt'

# model 1
FINETUNE='checkpoint/umt/umt-B-16____K710_65W_epoch200.pth'
...
# model 2
FINETUNE='checkpoint/umt/umt-B-16____K710_65W_epoch200_and_ppt_K710_65W.pth'
model='vit_base_patch16_224'
EMBEDDING_SIZE=768
PATCH_SIZE=16
NUM_FRAMES=8
...
# model 4
FINETUNE='checkpoint/umt/umt-L-16____K710_65W_epoch200_and_ppt_K710_65W.pth'
model='vit_large_patch16_224'
EMBEDDING_SIZE=1024
PATCH_SIZE=16
NUM_FRAMES=8
